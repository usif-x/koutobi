...
<template>
  <div v-if="show"
       class="fixed md:absolute md:top-18 md:right-50 top-16 left-1/2 -translate-x-1/2 md:translate-x-0 bg-white shadow-lg rounded-lg py-2 z-[999] w-[95%] md:w-72 max-h-96 overflow-y-auto mx-auto md:mx-0">
